...
**アカウントテーマ: 「占い動物園」 — 主役の黒猫を中心に様々な動物が日替わりで占い、最後に鳴いて締める。**

- **主役**: 黒猫🐈 (タロット担当・月間投稿の約4割)
- **サポート**: うさぎ🐇・狐🦊・フクロウ🦉・カラス🐦・ハリネズミ🦔・柴犬🐕 … 拡張中
- **占いツール (視覚で楽しめるものに限定)**: タロット・星座・パワーストーン・キャンドル・アンティーク鍵・ルーン・月相・古文書・ハーブ・花・木の実・おみくじ
- 全動画 **15秒・4カット・コメント誘導型** で統一 (= `prompts/script_user_3choice_short.md`)
- 動物の鳴き声 (にゃおー・きゅう・コーン・ホー…) がアカウントのブランドサウンド
- 結果はピン留めコメントで開示 → コメント率と再視聴率を最大化

詳細は `README.md` `docs/strategy.md` `config/cast.yaml` `config/tools.yaml` 参照。
